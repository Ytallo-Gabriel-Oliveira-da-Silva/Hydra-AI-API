  ...
  const releases = [
    {
      ...
      platform: 'linux',
      arch: 'x64',
      downloadUrl: 'https://cyber.hydra-ai.shop/downloads/hydra-cli-0.1.0-linux-x64.tar.gz',
    ...
    },
    {
      ...
      platform: 'windows',
      arch: 'x64',
      downloadUrl: 'https://cyber.hydra-ai.shop/downloads/hydra-cli-0.1.0-windows-x64.zip',
    ...
    },
    {
      ...
      platform: 'macos',
      arch: 'arm64',
      downloadUrl: 'https://cyber.hydra-ai.shop/downloads/hydra-cli-0.1.0-macos-arm64.tar.gz',
